<template>
  ...
  >
    ...
    <div class="grid grid-cols-2 gap-5 text-xl text-pink-800">
      ...
      <p>
        رقم الزبون : <span class="text-black"> {{ hallResInfo?.customerManegentPhonenumber }}</span>
      </p>
      <p>
    ...
    <div class="flex lg:gap-4 mr-8 mt-2 lg:pb-2 lg:mt-8">
      <v-btn @click="submit" color="pink-darken-2">تعديل </v-btn>
